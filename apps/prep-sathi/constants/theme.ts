...
export const Colors = {
  ...
  dark: {
    ...
    buttonSecondaryText: neutral.gray100,
    buttonDisabled: neutral.gray700,
    buttonDisabledText: neutral.gray500,
